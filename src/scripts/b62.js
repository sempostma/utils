(function () {
     ...
     * @type String
     */
    var Base62CodingSpace = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
     ...
     */
    function encodeBase62ToString(original) {
        ...
        while (true) {
            ...
            if (length == 6) // Not reaching the end
            {
                ...
                sb.push(Base62CodingSpace.charAt((read[0] >> (8 - length))));
                break;
            }
        }
        var str = sb.join('');
     ...
     */
    function decodeBase62ToArray(base62) {
        // Character count
        var count = 0;
     ...
     * @returns {String}
     */
    window.encodeBase62 = function encodeBase62(str) {

        if (typeof str !== 'string' || str === '') {
            return '';
        }

        str = encodeUtf8(str.toString());
        ...
        return encodeBase62ToString(bytes);
    };
     ...
     */
    window.decodeBase62 = function decodeBase62(str) {
        ...
        var bytes = decodeBase62ToArray(str);
        var sb = [];
